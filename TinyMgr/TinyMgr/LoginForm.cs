...
namespace TinyMgr
{
    public partial class LoginForm : ComponentFactory.Krypton.Toolkit.KryptonForm
    {
        ...
        public LoginForm(Starter start)
        {
            ...
            //获得对应用户名和密码
            bool saveuser = Properties.Settings.Default.saveuser;
            ckremberuser.Checked = saveuser;
            bool savepass = Properties.Settings.Default.savepass;
        ...
        void SaveLoginConfig()
        {
            ...
            Properties.Settings.Default.saveuser = rbuser;
            bool rbpass = ckremberpass.Checked;
            Properties.Settings.Default.savepass = rbpass;

            Properties.Settings.Default.username = rbuser ? username.Text : "";
            Properties.Settings.Default.pass = rbpass ? password.Text : "";
