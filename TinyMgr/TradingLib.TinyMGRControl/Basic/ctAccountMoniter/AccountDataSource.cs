...
namespace FutsMoniter.Controls
{
    public class AccountDataSource
    {
        ...
        private ConcurrentDictionary<int, AccountLite> accountrowmap = new ConcurrentDictionary<int, AccountLite>();
        ...
        {
            AccountLite acc = accountrowmap[rowidx];
            return acc != null ? acc.Account : "wu";
        }
        int row = 0;
        public void GotAccountLite(AccountLite acc)
        {
