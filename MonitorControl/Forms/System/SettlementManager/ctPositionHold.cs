...
namespace TradingLib.MoniterControl
{
    public partial class ctPositionHold : UserControl,IEventBinder
    {
        ...
        void gridPositionHold_DoubleClick(object sender, EventArgs e)
        {
            ...
            if (pos == null)
            {
                MoniterHelper.WindowMessage("请选择要处理的持仓");
                return;
            }
        ...
        public void OnInit()
        {
            CoreService.EventContrib.RegisterCallback("SettleCentre", "QryPositionHold", OnQryPositionHold);
        ...
        {
            CoreService.EventContrib.UnRegisterCallback("SettleCentre", "QryPositionHold", OnQryPositionHold);
