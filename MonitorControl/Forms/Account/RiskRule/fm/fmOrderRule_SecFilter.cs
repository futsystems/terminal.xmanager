...
{
    public partial class fmOrderRule_SecFilter : ComponentFactory.Krypton.Toolkit.KryptonForm
    {
        public fmOrderRule_SecFilter()
        {
            InitializeComponent();

            cbIsWhite.Items.Add("白名单");
            cbIsWhite.Items.Add("黑名单");
            cbIsWhite.SelectedIndex = 0;
        ...
        void btnSubmit_Click(object sender, EventArgs e)
        {
            if (this.Rule == null)
            {
                ...
                var args = new
                {
                    is_white = cbIsWhite.SelectedIndex==0?true:false,
