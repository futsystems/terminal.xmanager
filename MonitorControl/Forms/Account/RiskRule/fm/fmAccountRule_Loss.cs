...
{
    public partial class fmAccountRule_Loss : ComponentFactory.Krypton.Toolkit.KryptonForm
    {
        public fmAccountRule_Loss()
        {
            InitializeComponent();
            this.Load += new EventHandler(fmAccountRule_Loss_Load);
        }

        void fmAccountRule_Loss_Load(object sender, EventArgs e)
        {
        ...
        void btnSubmit_Click(object sender, EventArgs e)
        {
            if (this.Rule == null)
            {
                ...
                var args = new
                {
                    loss_flat = loss_flat.Value,
                    loss_warn = loss_warn.Value,
                };
