...
{
    public partial class fmAccountRule_HoldRatio : ComponentFactory.Krypton.Toolkit.KryptonForm
    {
        public fmAccountRule_HoldRatio()
        {
            InitializeComponent();
        ...
        void btnSubmit_Click(object sender, EventArgs e)
        {
            if (this.Rule == null)
            {
                ...
                var args = new
                {
                    hold_ratio = holdratio.Value,
                    check_time = Util.ToTLTime(checktime.Value)
                };
