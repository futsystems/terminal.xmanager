...
{
    public partial class fmOrderRule_MaxTradeSize : ComponentFactory.Krypton.Toolkit.KryptonForm
    {
        public fmOrderRule_MaxTradeSize()
        {
            InitializeComponent();
        ...
        void btnSubmit_Click(object sender, EventArgs e)
        {
            if (this.Rule == null)
            {
                ...
                var args = new
                {
                    trade_size = (int)maxtradesize.Value,
