...
{
    public partial class fmAccountRule_EquityByCredit : ComponentFactory.Krypton.Toolkit.KryptonForm
    {
        public fmAccountRule_EquityByCredit()
        {
            InitializeComponent();
            this.Load += new EventHandler(fmAccountRule_EquityByCredit_Load);
        }

        void fmAccountRule_EquityByCredit_Load(object sender, EventArgs e)
        {
