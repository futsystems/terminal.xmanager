...
{
    public partial class fmAccountRule_MaxChange : ComponentFactory.Krypton.Toolkit.KryptonForm
    {
        public fmAccountRule_MaxChange()
        {
            InitializeComponent();
        ...
        void btnSubmit_Click(object sender, EventArgs e)
        {
            if (this.Rule == null)
            {
                ...
                var args = new
                {
                    dn_pect = dn_pect.Value,
                    up_pect = up_pect.Value,
