...
namespace TradingLib.MoniterCore
{
    public partial class TLClientNet
    {
        ...
        {
            logger.Debug("got ruleset response:" + response.ToString());
        ...
        {
            logger.Debug("got ruleitem response:" + response.ToString());
        ...
        {
            logger.Debug("got ruleitem update response:" + response.ToString());
        ...
        {
            logger.Debug("got ruleitem delete response:" + response.ToString());
